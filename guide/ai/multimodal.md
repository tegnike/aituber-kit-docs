...
![マルチモーダル対応モデル](/images/ai_vay45.webp)
...
2. 「マルチモーダルを利用する」設定を有効にする
3. Webカメラや画面共有の有効化（必要に応じて）
4. メッセージを送信

### マルチモーダルを利用する設定

「マルチモーダルを利用する」設定を有効にすると、画像付きメッセージが送信された場合にマルチモーダル機能が利用されます。無効にすると、画像が添付されていてもテキストのみがAIに送信されます。
...
![マルチモーダルAI画像](/images/ai_k3nfi.webp)
